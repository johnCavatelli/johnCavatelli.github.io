...
//Model URLs
const shovelURL = new URL('../garden/models/shovel.glb', import.meta.url);
const canURL = new URL('../garden/models/can.glb', import.meta.url);
const cloudURL = new URL('../garden/models/cloud.glb', import.meta.url);
const boxURL = new URL('../garden/models/box.glb', import.meta.url);
const packetURL = new URL('../garden/models/packet_1.glb', import.meta.url);
const packet2URL = new URL('../garden/models/packet_2.glb', import.meta.url);
const packet3URL = new URL('../garden/models/packet_3.glb', import.meta.url);
const packet4URL = new URL('../garden/models/packet_4.glb', import.meta.url);
const packet5URL = new URL('../garden/models/packet_5.glb', import.meta.url);
const packet6URL = new URL('../garden/models/packet_6.glb', import.meta.url);
const tableURL = new URL('../garden/models/Table.glb', import.meta.url);
const plant1URL = new URL('../garden/models/flower_1.glb', import.meta.url);
const plant2URL = new URL('../garden/models/flower_2.glb', import.meta.url);
const plant3URL = new URL('../garden/models/flower_3.glb', import.meta.url);
const plant4URL = new URL('../garden/models/flower_4.glb', import.meta.url);
const plant5URL = new URL('../garden/models/flower_5.glb', import.meta.url);
const plant6URL = new URL('../garden/models/flower_6.glb', import.meta.url);
const windmillBaseURL = new URL('../garden/models/windmillBase.glb', import.meta.url);
const windmillBladeURL = new URL('../garden/models/windMillBlade.glb', import.meta.url);
...
plantHitboxToArticle[plant1_hitbox.id] =['<p class="article_title">About Me 👨‍💻</p>'+
                                        '<p class="article_text">Hi there! I\'m AJ, and I like creating things. Whether it\'s art, code, or music, what makes me most excited about life is making things for the world to see. I\'m 19 years old and going to college at the University of Iowa. If I\'m not coding or in class, you can catch me drawing birds, running, or playing Smash Bros. with friends. I built this little garden in the sky so you can take a glimpse into my life. I hope you like my garden and I can work for your awesome company.<br>Cheers!</p>'
                                        ,'','']
plantHitboxToArticle[plant2_hitbox.id] =['<p class="article_title">GitHub 💻</p>'+
                                        '<p class="article_text">Please mind the gaps! School and internships are a lot sometimes!😮‍💨<br> (John Cavatelli is my screen name!)</p>',
...
plantHitboxToArticle[plant4_hitbox.id] =['<p class="article_title">Personal Projects 💾</p>'+
                                        ...
                                        '<hr><p class="article_subtext"><b>Sumthing Summarized:</b> Built during the University of Iowa Hackathon 2022, this web app/chrome extension allows users to gather text during research and have it summarized using OpenAI.</p>'+
                                        '<hr><p class="article_subtext"><b>This Website:</b> This garden was build with HTML/CSS and the ThreeJS library to utilize WebGL and make it 3D.</p>'+
                                        '<hr><p class="article_subtext"><b>Daily Bird:</b> Project build in Python utilizing both the Google Custom Search API and the Ebird.org  API (a website containing Wikipedia-style information about birds). Gathers images and information about the birds to present on a webpage that\'s updated daily.</p>',
                                        '','']
